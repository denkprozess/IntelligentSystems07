...
public class PlanningProblem {
    ...
    public PlanningProblem(List<Resource> resources, List<Product> products, List<Job> jobs, List<IHardConstraint> hardConstraints, List<ISoftConstraint> softConstraints, List<IEvent> events, ITargetFunction targetFunction) {
